...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		-50.f, -50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.6f, 0.6f, 0.6f,
		 50.f, -50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.2f, 0.3f, 0.5f,
		 50.f,  50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.6f, 0.8f, 0.4f,
		 50.f,  50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.6f, 0.8f, 0.4f,
		-50.f,  50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.2f, 0.3f, 0.5f,
		-50.f, -50.f, -50.f,  0.0f,  0.0f, -1.0f,   0.6f, 0.6f, 0.6f,

		// spate (in planul z=50, normala este (0,0,1))
		-50.f, -50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.8f, 0.4f, 0.2f,
		 50.f, -50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.5f, 0.5f, 0.5f,
		 50.f,  50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.1f, 0.1f, 0.5f,
		 50.f,  50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.1f, 0.1f, 0.5f,
		-50.f,  50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.2f, 0.2f, 0.2f,
		-50.f, -50.f,  50.f,  0.0f,  0.0f,  1.0f,   0.8f, 0.4f, 0.2f,

		// fata din dreapta (in planul x=-50, normala este (-1,0,0))
		-50.f,  50.f,  50.f, -1.0f,  0.0f,  0.0f,   0.2f, 0.2f, 0.2f,
		-50.f,  50.f, -50.f, -1.0f,  0.0f,  0.0f,   0.2f, 0.3f, 0.5f,
		-50.f, -50.f, -50.f, -1.0f,  0.0f,  0.0f,   0.6f, 0.6f, 0.6f,
		-50.f, -50.f, -50.f, -1.0f,  0.0f,  0.0f,   0.6f, 0.6f, 0.6f,
		-50.f, -50.f,  50.f, -1.0f,  0.0f,  0.0f,   0.8f, 0.4f, 0.2f,
		-50.f,  50.f,  50.f, -1.0f,  0.0f,  0.0f,   0.2f, 0.2f, 0.2f,

		// fata din stanga (in planul x=50, normala este (1,0,0))
		 50.f,  50.f,  50.f,  1.0f,  0.0f,  0.0f,   0.1f, 0.1f, 0.5f,
		 50.f,  50.f, -50.f,  1.0f,  0.0f,  0.0f,   0.6f, 0.8f, 0.4f,
		 50.f, -50.f, -50.f,  1.0f,  0.0f,  0.0f,   0.2f, 0.3f, 0.5f,
		 50.f, -50.f, -50.f,  1.0f,  0.0f,  0.0f,   0.2f, 0.3f, 0.5f,
		 50.f, -50.f,  50.f,  1.0f,  0.0f,  0.0f,   0.5f, 0.5f, 0.5f,
		 50.f,  50.f,  50.f,  1.0f,  0.0f,  0.0f,   0.1f, 0.1f, 0.5f,

		 // jos (in planul y=-50, normala este (0,-1,0))
		-50.f, -50.f, -50.f,  0.0f, -1.0f,  0.0f,   0.6f, 0.6f, 0.6f,
		 50.f, -50.f, -50.f,  0.0f, -1.0f,  0.0f,   0.2f, 0.3f, 0.5f,
		 50.f, -50.f,  50.f,  0.0f, -1.0f,  0.0f,   0.5f, 0.5f, 0.5f,
		 50.f, -50.f,  50.f,  0.0f, -1.0f,  0.0f,   0.5f, 0.5f, 0.5f,
		-50.f, -50.f,  50.f,  0.0f, -1.0f,  0.0f,   0.8f, 0.4f, 0.2f,
		-50.f, -50.f, -50.f,  0.0f, -1.0f,  0.0f,   0.6f, 0.6f, 0.6f,

		// sus (in planul y=50, normala este (0,1,0))
		-50.f,  50.f, -50.f,  0.0f,  1.0f,  0.0f,   0.2f, 0.3f, 0.5f,
		 50.f,  50.f, -50.f,  0.0f,  1.0f,  0.0f,   0.6f, 0.8f, 0.4f,
		 50.f,  50.f,  50.f,  0.0f,  1.0f,  0.0f,   0.1f, 0.1f, 0.5f,
		 50.f,  50.f,  50.f,  0.0f,  1.0f,  0.0f,   0.1f, 0.1f, 0.5f,
		-50.f,  50.f,  50.f,  0.0f,  1.0f,  0.0f,   0.2f, 0.2f, 0.2f,
		-50.f,  50.f, -50.f,  0.0f,  1.0f,  0.0f,   0.2f, 0.3f, 0.5f,
	};
...
{
	ProgramId = LoadShaders("../../res/10_01_Shader.vert", "../../res/10_01_Shader.frag");
