...
void CreateVBO(void)
{
	...
	glVertexAttribPointer(2, 4, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (GLvoid*)(5 * sizeof(GLfloat)));
}
...
{
	ProgramIdv = LoadShaders("../../res/10_02v_Shader.vert", "../../res/10_02v_Shader.frag");
	glUseProgram(ProgramIdv);
}
void CreateShadersFragment(void)
{
	ProgramIdf = LoadShaders("../../res/10_02f_Shader.vert", "../../res/10_02f_Shader.frag");
